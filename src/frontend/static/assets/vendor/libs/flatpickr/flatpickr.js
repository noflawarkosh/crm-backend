                ...
                e.exports = function () {
                    ...
                    var n = ["onChange", "onClose", "onDayCreate", "onDestroy", "onKeyDown", "onMonthChange", "onOpen", "onParseConfig", "onReady", "onValueUpdate", "onYearChange", "onPreCalendarPosition"],
                        a = {
                            ...
                            rangeSeparator: " по ",
                            weekAbbreviation: "Нд",
                            scrollTitle: "Прокрутить для увеличения",
                            toggleTitle: "Нажать для переключения",
                            amPM: ["AM", "PM"],
                            yearAriaLabel: "Год",
                        ...
                        return function (e, t, i, o) {
                            if (0 === e || e) {
                                ...
                                if (e instanceof Date) l = new Date(e.getTime()); else if ("string" != typeof e && void 0 !== e.toFixed) l = new Date(e); else if ("string" == typeof e) {
                                    var d = t || (n || a).dateFormat, u = String(e).trim();
                                    if ("today" === u) l = new Date, i = !0; else if (n && n.parseDate) l = n.parseDate(e, d); else if (/Z$/.test(u) || /GMT$/.test(u)) l = new Date(e); else {
                                        for (var f = void 0, m = [], g = 0, p = 0, h = ""; g < d.length; g++) {
                                            var b = d[g], w = "\\" === b, y = "\\" === d[g - 1] || w;
                                            if (D[b] && !y) {
                                                h += D[b];
                                        ...
                                        l = n && n.noCalendar ? new Date((new Date).setHours(0, 0, 0, 0)) : new Date((new Date).getFullYear(), 0, 1, 0, 0, 0, 0), m.forEach((function (e) {
                                            var t = e.fn, n = e.val;
                                            return l = t(l, n, c) || l
                                        })), l = f ? l : void 0
                                    }
                    ...
                    function I(p, v) {
                        ...
                        function A(e) {
                            ...
                            void 0 !== e && "blur" !== e.type && function (e) {
                                ...
                                if (void 0 !== a.value && 2 === a.value.length) {
                                    var u = a === b.hourElement, f = a === b.minuteElement;
                                    d < i ? (d = l + d + r(!u) + (r(u) && r(!b.amPM)), f && B(void 0, -1, b.hourElement)) : d > l && (d = a === b.hourElement ? d - l - r(!b.amPM) : i, f && B(void 0, 1, b.hourElement)), b.amPM && u && (1 === c ? d + s === 23 : Math.abs(d - s) > c) && (b.amPM.textContent = b.l10n.amPM[r(b.amPM.textContent === b.l10n.amPM[0])]), a.value = o(d)
                                }
                            }(e);
                            var a = b._input.value;
                            N(), ke(), b._input.value !== a && b._debouncedChange()
                        }
                        ...
                        function N() {
                            if (void 0 !== b.hourElement && void 0 !== b.minuteElement) {
                                var e = (parseInt(b.hourElement.value.slice(-2), 10) || 0) % 24,
                                    ...
                                    n = void 0 !== b.secondElement ? (parseInt(b.secondElement.value, 10) || 0) % 60 : 0;
                                ...
                                var a = void 0 !== b.config.minTime || b.config.minDate && b.minDateHasTime && b.latestSelectedDateObj && 0 === C(b.latestSelectedDateObj, b.config.minDate, !0),
                                    i = void 0 !== b.config.maxTime || b.config.maxDate && b.maxDateHasTime && b.latestSelectedDateObj && 0 === C(b.latestSelectedDateObj, b.config.maxDate, !0);
                                if (void 0 !== b.config.maxTime && void 0 !== b.config.minTime && b.config.minTime > b.config.maxTime) {
                                    var o = x(b.config.minTime.getHours(), b.config.minTime.getMinutes(), b.config.minTime.getSeconds()),
                                        l = x(b.config.maxTime.getHours(), b.config.maxTime.getMinutes(), b.config.maxTime.getSeconds()),
                                        c = x(e, t, n);
                                    if (c > l && c < o) {
                                        var s = E(o);
                                        e = s[0], t = s[1], n = s[2]
                                    ...
                                    if (i) {
                                        ...
                                        (e = Math.min(e, d.getHours())) === d.getHours() && (t = Math.min(t, d.getMinutes())), t === d.getMinutes() && (n = Math.min(n, d.getSeconds()))
                                    }
                                    if (a) {
                                        var u = void 0 !== b.config.minTime ? b.config.minTime : b.config.minDate;
                                        (e = Math.max(e, u.getHours())) === u.getHours() && t < u.getMinutes() && (t = u.getMinutes()), t === u.getMinutes() && (n = Math.max(n, u.getSeconds()))
                                    }
                                }
                                Y(e, t, n)
                            }
                        ...
                        function Y(e, t, n) {
                            void 0 !== b.latestSelectedDateObj && b.latestSelectedDateObj.setHours(e % 24, t, n || 0, 0), b.hourElement && b.minuteElement && !b.isMobile && (b.hourElement.value = o(b.config.time_24hr ? e : (12 + e) % 12 + 12 * r(e % 12 == 0)), b.minuteElement.value = o(t), void 0 !== b.amPM && (b.amPM.textContent = b.l10n.amPM[r(e >= 12)]), void 0 !== b.secondElement && (b.secondElement.value = o(n)))
                        }

                        function j(e) {
                            var t = g(e), n = parseInt(t.value) + (e.delta || 0);
                            (n / 1e3 > 1 || "Enter" === e.key && !/[^\d]/.test(n.toString())) && ae(n)
                        }
                        ...
                        function H(e, t, n, a) {
                            return t instanceof Array ? t.forEach((function (t) {
                                ...
                                return H(e, t, n, a)
                            })) : (e.addEventListener(t, n, a), void b._handlers.push({
                                remove: function () {
                        ...
                        function R(e, t) {
                            var n = void 0 !== e ? b.parseDate(e) : b.latestSelectedDateObj || (b.config.minDate && b.config.minDate > b.now ? b.config.minDate : b.config.maxDate && b.config.maxDate < b.now ? b.config.maxDate : b.now),
                                a = b.currentYear, i = b.currentMonth;
                            try {
                                void 0 !== n && (b.currentYear = n.getFullYear(), b.currentMonth = n.getMonth())
                            } catch (e) {
                                e.message = "Invalid date supplied: " + n, b.config.errorHandler(e)
                            }
                            t && b.currentYear !== a && (ye("onYearChange"), z()), !t || b.currentYear === a && b.currentMonth === i || ye("onMonthChange"), b.redraw()
                        }
                        ...
                        function B(e, t, n) {
                            var a = e && g(e), i = n || a && a.parentNode && a.parentNode.firstChild,
                                o = Ce("increment");
                            o.delta = t, i && i.dispatchEvent(o)
                        }

                        function J(e, t, n, a) {
                            var i = ie(t, !0), o = d("span", e, t.getDate().toString());
                            return o.dateObj = t, o.$i = a, o.setAttribute("aria-label", b.formatDate(t, b.config.ariaDateFormat)), -1 === e.indexOf("hidden") && 0 === C(t, b.now) && (b.todayDateElem = o, o.classList.add("today"), o.setAttribute("aria-current", "date")), i ? (o.tabIndex = -1, Me(t) && (o.classList.add("selected"), b.selectedDateElem = o, "range" === b.config.mode && (s(o, "startRange", b.selectedDates[0] && 0 === C(t, b.selectedDates[0], !0)), s(o, "endRange", b.selectedDates[1] && 0 === C(t, b.selectedDates[1], !0)), "nextMonthDay" === e && o.classList.add("inRange")))) : o.classList.add("flatpickr-disabled"), "range" === b.config.mode && function (e) {
                                return !("range" !== b.config.mode || b.selectedDates.length < 2) && C(e, b.selectedDates[0]) >= 0 && C(e, b.selectedDates[1]) <= 0
                            }(t) && !Me(t) && o.classList.add("inRange"), b.weekNumbers && 1 === b.config.showMonths && "prevMonthDay" !== e && a % 7 == 6 && b.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + b.config.getWeek(t) + "</span>"), ye("onDayCreate", o), o
                        }

                        function K(e) {
                            e.focus(), "range" === b.config.mode && ce(e)
                        }

                        function U(e) {
                            for (var t = e > 0 ? 0 : b.config.showMonths - 1, n = e > 0 ? b.config.showMonths : -1, a = t; a != n; a += e) for (var i = b.daysContainer.children[a], o = e > 0 ? 0 : i.children.length - 1, r = e > 0 ? i.children.length : -1, l = o; l != r; l += e) {
                                var c = i.children[l];
                                if (-1 === c.className.indexOf("hidden") && ie(c.dateObj)) return c
                            }
                        }

                        function q(e, t) {
                            var n = I(), a = oe(n || document.body),
                                i = void 0 !== e ? e : a ? n : void 0 !== b.selectedDateElem && oe(b.selectedDateElem) ? b.selectedDateElem : void 0 !== b.todayDateElem && oe(b.todayDateElem) ? b.todayDateElem : U(t > 0 ? 1 : -1);
                            void 0 === i ? b._input.focus() : a ? function (e, t) {
                                for (var n = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : b.currentMonth, a = t > 0 ? b.config.showMonths : -1, i = t > 0 ? 1 : -1, o = n - b.currentMonth; o != a; o += i) for (var r = b.daysContainer.children[o], l = n - b.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0, c = r.children.length, s = l; s >= 0 && s < c && s != (t > 0 ? c : -1); s += i) {
                                    var d = r.children[s];
                                    if (-1 === d.className.indexOf("hidden") && ie(d.dateObj) && Math.abs(e.$i - s) >= Math.abs(t)) return K(d)
                                }
                                b.changeMonth(i), q(U(i), 0)
                            }(i, t) : K(i)
                        }

                        function $(e, t) {
                            for (var n = (new Date(e, t, 1).getDay() - b.l10n.firstDayOfWeek + 7) % 7, a = b.utils.getDaysInMonth((t - 1 + 12) % 12, e), i = b.utils.getDaysInMonth(t, e), o = window.document.createDocumentFragment(), r = b.config.showMonths > 1, l = r ? "prevMonthDay hidden" : "prevMonthDay", c = r ? "nextMonthDay hidden" : "nextMonthDay", s = a + 1 - n, u = 0; s <= a; s++, u++) o.appendChild(J("flatpickr-day " + l, new Date(e, t - 1, s), 0, u));
                            for (s = 1; s <= i; s++, u++) o.appendChild(J("flatpickr-day", new Date(e, t, s), 0, u));
                            for (var f = i + 1; f <= 42 - n && (1 === b.config.showMonths || u % 7 != 0); f++, u++) o.appendChild(J("flatpickr-day " + c, new Date(e, t + 1, f % i), 0, u));
                        ...
                        function V() {
                            if (void 0 !== b.daysContainer) {
                                ...
                                for (var e = document.createDocumentFragment(), t = 0; t < b.config.showMonths; t++) {
                                    ...
                                    n.setMonth(b.currentMonth + t), e.appendChild($(n.getFullYear(), n.getMonth()))
                                }
                                b.daysContainer.appendChild(e), b.days = b.daysContainer.firstChild, "range" === b.config.mode && 1 === b.selectedDates.length && ce()
                            }
                        }
                        ...
                        function G() {
                            ...
                            b.config.showMonths > 1 || "static" === b.config.monthSelectorType ? e = d("span", "cur-month") : (b.monthsDropdownContainer = d("select", "flatpickr-monthDropdown-months"), b.monthsDropdownContainer.setAttribute("aria-label", b.l10n.monthAriaLabel), H(b.monthsDropdownContainer, "change", (function (e) {
                                var t = g(e), n = parseInt(t.value, 10);
                                b.changeMonth(n - b.currentMonth), ye("onMonthChange")
                            })), z(), e = b.monthsDropdownContainer);
                        ...
                        function X() {
                            if (b.weekdayContainer) {
                                ...
                                for (var a = b.config.showMonths; a--;) b.weekdayContainer.children[a].innerHTML = "\n      <span class='flatpickr-weekday'>\n        " + n.join("</span><span class='flatpickr-weekday'>") + "\n      </span>\n      "
                            }
                        }
                        ...
                        function ee(e, t) {
                            ...
                            n < 0 && !0 === b._hidePrevMonthArrow || n > 0 && !0 === b._hideNextMonthArrow || (b.currentMonth += n, (b.currentMonth < 0 || b.currentMonth > 11) && (b.currentYear += b.currentMonth > 11 ? 1 : -1, b.currentMonth = (b.currentMonth + 12) % 12, ye("onYearChange"), z()), V(), ye("onMonthChange"), xe())
                        }
                        ...
                        function ne(e) {
                            if (b.isOpen && !b.config.inline) {
                                var t = g(e), n = te(t),
                                    a = !(t === b.input || t === b.altInput || b.element.contains(t) || e.path && e.path.indexOf && (~e.path.indexOf(b.input) || ~e.path.indexOf(b.altInput)) || n || te(e.relatedTarget)),
                                    i = !b.config.ignoredFocusElements.some((function (e) {
                                        return e.contains(t)
                                    }));
                                a && i && (b.config.allowInput && b.setDate(b._input.value, !1, b.config.altInput ? b.config.altFormat : b.config.dateFormat), void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement && "" !== b.input.value && void 0 !== b.input.value && A(), b.close(), b.config && "range" === b.config.mode && 1 === b.selectedDates.length && b.clear(!1))
                            }
                        }
                        ...
                        function ae(e) {
                            if (!(!e || b.config.minDate && e < b.config.minDate.getFullYear() || b.config.maxDate && e > b.config.maxDate.getFullYear())) {
                                ...
                                b.currentYear = t || b.currentYear, b.config.maxDate && b.currentYear === b.config.maxDate.getFullYear() ? b.currentMonth = Math.min(b.config.maxDate.getMonth(), b.currentMonth) : b.config.minDate && b.currentYear === b.config.minDate.getFullYear() && (b.currentMonth = Math.max(b.config.minDate.getMonth(), b.currentMonth)), n && (b.redraw(), ye("onYearChange"), z())
                            }
                        }
                        ...
                        function ie(e, t) {
                            ...
                            if (b.config.minDate && a && C(a, b.config.minDate, void 0 !== t ? t : !b.minDateHasTime) < 0 || b.config.maxDate && a && C(a, b.config.maxDate, void 0 !== t ? t : !b.maxDateHasTime) > 0) return !1;
                            if (!b.config.enable && 0 === b.config.disable.length) return !0;
                            if (void 0 === a) return !1;
                            for (var i = !!b.config.enable, o = null !== (n = b.config.enable) && void 0 !== n ? n : b.config.disable, r = 0, l = void 0; r < o.length; r++) {
                        ...
                        function re(e) {
                            var t = e.target === b._input, n = b._input.value.trimEnd() !== Ee();
                        ...
                        function le(e) {
                            var t = g(e), n = b.config.wrap ? p.contains(t) : t === b._input, a = b.config.allowInput,
                                i = b.isOpen && (!a || !n), o = b.config.inline && n && !a;
                            if (13 === e.keyCode && n) {
                                if (a) return b.setDate(b._input.value, !0, t === b.altInput ? b.config.altFormat : b.config.dateFormat), b.close(), t.blur();
                                b.open()
                            } else if (te(t) || i || o) {
                                var r = !!b.timeContainer && b.timeContainer.contains(t);
                                switch (e.keyCode) {
                                    case 13:
                                        r ? (e.preventDefault(), A(), pe()) : he(e);
                                        break;
                                    case 27:
                                        e.preventDefault(), pe();
                                        break;
                                    ...
                                    case 39:
                                        if (r || n) b.hourElement && b.hourElement.focus(); else {
                                            e.preventDefault();
                                            var l = I();
                                            if (void 0 !== b.daysContainer && (!1 === a || l && oe(l))) {
                                                var c = 39 === e.keyCode ? 1 : -1;
                                                e.ctrlKey ? (e.stopPropagation(), ee(c), q(U(1), 0)) : q(void 0, c)
                                            }
                                        }
                                        break;
                                    case 38:
                                    case 40:
                                        ...
                                        b.daysContainer && void 0 !== t.$i || t === b.input || t === b.altInput ? e.ctrlKey ? (e.stopPropagation(), ae(b.currentYear - s), q(U(1), 0)) : r || q(void 0, 7 * s) : t === b.currentYearElement ? ae(b.currentYear - s) : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(), A(e), b._debouncedChange());
                                        break;
                                    case 9:
                                        if (r) {
                            ...
                            if (void 0 !== b.amPM && t === b.amPM) switch (e.key) {
                                ...
                                case b.l10n.amPM[0].charAt(0).toLowerCase():
                                    b.amPM.textContent = b.l10n.amPM[0], N(), ke();
                                    break;
                                case b.l10n.amPM[1].charAt(0):
                                case b.l10n.amPM[1].charAt(0).toLowerCase():
                                    b.amPM.textContent = b.l10n.amPM[1], N(), ke()
                            }
                            (n || te(t)) && ye("onKeyDown", e)
                        }

                        function ce(e, t) {
                            if (void 0 === t && (t = "flatpickr-day"), 1 === b.selectedDates.length && (!e || e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))) {
                                for (var n = e ? e.dateObj.getTime() : b.days.firstElementChild.dateObj.getTime(), a = b.parseDate(b.selectedDates[0], void 0, !0).getTime(), i = Math.min(n, b.selectedDates[0].getTime()), o = Math.max(n, b.selectedDates[0].getTime()), r = !1, l = 0, c = 0, s = i; s < o; s += k.DAY) ie(new Date(s), !0) || (r = r || s > i && s < o, s < a && (!l || s > l) ? l = s : s > a && (!c || s < c) && (c = s));
                                Array.from(b.rContainer.querySelectorAll("*:nth-child(-n+" + b.config.showMonths + ") > ." + t)).forEach((function (t) {
                                    var i = t.dateObj.getTime(), o = l > 0 && i < l || c > 0 && i > c;
                                    ...
                                    r && !o || (["startRange", "inRange", "endRange", "notAllowed"].forEach((function (e) {
                                        t.classList.remove(e)
                                    })), void 0 !== e && (e.classList.add(n <= b.selectedDates[0].getTime() ? "startRange" : "endRange"), a < n && i === a ? t.classList.add("startRange") : a > n && i === a && t.classList.add("endRange"), i >= l && (0 === c || i <= c) && M(i, a, n) && t.classList.add("inRange")))
                                }))
                            }
                        }

                        function se() {
                            !b.isOpen || b.config.static || b.config.inline || me()
                        }
                        ...
                        function de(e) {
                            return function (t) {
                                ...
                                void 0 !== n && (b["min" === e ? "minDateHasTime" : "maxDateHasTime"] = n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0), b.selectedDates && (b.selectedDates = b.selectedDates.filter((function (e) {
                                    return ie(e)
                                })), b.selectedDates.length || "min" !== e || P(n), ke()), b.daysContainer && (ge(), void 0 !== n ? b.currentYearElement[e] = n.getFullYear().toString() : b.currentYearElement.removeAttribute(e), b.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear())
                            }
                        }
                        ...
                        function fe() {
                            "object" != typeof b.config.locale && void 0 === O.l10ns[b.config.locale] && b.config.errorHandler(new Error("flatpickr: invalid locale " + b.config.locale)), b.l10n = e(e({}, O.l10ns.default), "object" == typeof b.config.locale ? b.config.locale : "default" !== b.config.locale ? O.l10ns[b.config.locale] : void 0), D.D = "(" + b.l10n.weekdays.shorthand.join("|") + ")", D.l = "(" + b.l10n.weekdays.longhand.join("|") + ")", D.M = "(" + b.l10n.months.shorthand.join("|") + ")", D.F = "(" + b.l10n.months.longhand.join("|") + ")", D.K = "(" + b.l10n.amPM[0] + "|" + b.l10n.amPM[1] + "|" + b.l10n.amPM[0].toLowerCase() + "|" + b.l10n.amPM[1].toLowerCase() + ")", void 0 === e(e({}, v), JSON.parse(JSON.stringify(p.dataset || {}))).time_24hr && void 0 === O.defaultConfig.time_24hr && (b.config.time_24hr = b.l10n.time_24hr), b.formatDate = w(b), b.parseDate = y({
                                config: b.config,
                                l10n: b.l10n
                            })
                        }
                            ...
                            if ("function" != typeof b.config.position) {
                                if (void 0 !== b.calendarContainer) {
                                    ...
                                    var t = e || b._positionElement,
                                        ...
                                        }), 0), a = b.calendarContainer.offsetWidth, i = b.config.position.split(" "),
                                        o = i[0], r = i.length > 1 ? i[1] : null, l = t.getBoundingClientRect(),
                                    ...
                                    if (s(b.calendarContainer, "arrowTop", !d), s(b.calendarContainer, "arrowBottom", d), !b.config.inline) {
                                        ...
                                        "center" === r ? (f -= (a - l.width) / 2, m = !0) : "right" === r && (f -= a - l.width, g = !0), s(b.calendarContainer, "arrowLeft", !m && !g), s(b.calendarContainer, "arrowCenter", m), s(b.calendarContainer, "arrowRight", g);
                                        var p = window.document.body.offsetWidth - (window.pageXOffset + l.right),
                                            h = f + a > window.document.body.offsetWidth,
                                            v = p + a > window.document.body.offsetWidth;
                                        if (s(b.calendarContainer, "rightMost", h), !b.config.static) if (b.calendarContainer.style.top = u + "px", h) if (v) {
                                            var D = function () {
                                            ...
                                            if (void 0 === D) return;
                                            var w = window.document.body.offsetWidth, y = Math.max(0, w / 2 - a / 2),
                                                C = D.cssRules.length, M = "{left:" + l.left + "px;right:auto;}";
                                            s(b.calendarContainer, "rightMost", !1), s(b.calendarContainer, "centerMost", !0), D.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + M, C), b.calendarContainer.style.left = y + "px", b.calendarContainer.style.right = "auto"
                                        } else b.calendarContainer.style.left = "auto", b.calendarContainer.style.right = p + "px"; else b.calendarContainer.style.left = f + "px", b.calendarContainer.style.right = "auto"
                                    }
                                }
                        ...
                        function ge() {
                            b.config.noCalendar || b.isMobile || (z(), xe(), V())
                        }
                        ...
                        function he(e) {
                            ...
                            if (void 0 !== t) {
                                var n = t, a = b.latestSelectedDateObj = new Date(n.dateObj.getTime()),
                                    i = (a.getMonth() < b.currentMonth || a.getMonth() > b.currentMonth + b.config.showMonths - 1) && "range" !== b.config.mode;
                                if (b.selectedDateElem = n, "single" === b.config.mode) b.selectedDates = [a]; else if ("multiple" === b.config.mode) {
                                    var o = Me(a);
                                    o ? b.selectedDates.splice(parseInt(o), 1) : b.selectedDates.push(a)
                                } else "range" === b.config.mode && (2 === b.selectedDates.length && b.clear(!1, !1), b.latestSelectedDateObj = a, b.selectedDates.push(a), 0 !== C(a, b.selectedDates[0], !0) && b.selectedDates.sort((function (e, t) {
                                    return e.getTime() - t.getTime()
                                })));
                                if (N(), i) {
                                    var r = b.currentYear !== a.getFullYear();
                                    b.currentYear = a.getFullYear(), b.currentMonth = a.getMonth(), r && (ye("onYearChange"), z()), ye("onMonthChange")
                                }
                                if (xe(), V(), ke(), i || "range" === b.config.mode || 1 !== b.config.showMonths ? void 0 !== b.selectedDateElem && void 0 === b.hourElement && b.selectedDateElem && b.selectedDateElem.focus() : K(n), void 0 !== b.hourElement && void 0 !== b.hourElement && b.hourElement.focus(), b.config.closeOnSelect) {
                        ...
                        b.parseDate = y({
                            config: b.config,
                            l10n: b.l10n
                        }), b._handlers = [], b.pluginElements = [], b.loadedPlugins = [], b._bind = H, b._setHoursFromDate = P, b._positionCalendar = me, b.changeMonth = ee, b.changeYear = ae, b.clear = function (e, t) {
                        ...
                        }, b.onMouseOver = ce, b._createElement = d, b.createDay = J, b.destroy = function () {
                        ...
                        }, b.isEnabled = ie, b.jumpToDate = R, b.updateValue = ke, b.open = function (e, t) {
                            ...
                            if (!b._input.disabled && !b.config.inline) {
                                var a = b.isOpen;
                                b.isOpen = !0, a || (b.calendarContainer.classList.add("open"), b._input.classList.add("active"), ye("onOpen"), me(t)), !0 === b.config.enableTime && !0 === b.config.noCalendar && (!1 !== b.config.allowInput || void 0 !== e && b.timeContainer.contains(e.relatedTarget) || setTimeout((function () {
                                    return b.hourElement.select()
                                }), 50))
                            }
                        }, b.redraw = ge, b.set = function (e, t) {
                            if (null !== e && "object" == typeof e) for (var a in Object.assign(b.config, e), e) void 0 !== ve[a] && ve[a].forEach((function (e) {
                                return e()
                            ...
                            De(e, n), b.latestSelectedDateObj = b.selectedDates[b.selectedDates.length - 1], b.redraw(), R(void 0, t), P(), 0 === b.selectedDates.length && b.clear(!1), ke(t), t && ye("onChange")
                        }, b.toggle = function (e) {
                        ...
                        var ve = {
                            ...
                            positionElement: [we],
                            clickOpens: [function () {
                                !0 === b.config.clickOpens ? (H(b._input, "focus", b.open), H(b._input, "click", b.open)) : (b._input.removeEventListener("focus", b.open), b._input.removeEventListener("click", b.open))
                            }]
                        };
                        ...
                        function De(e, t) {
                            ...
                            b.selectedDates = b.config.allowInvalidPreload ? n : n.filter((function (e) {
                                return e instanceof Date && ie(e, !1)
                        ...
                        function ye(e, t) {
                            if (void 0 !== b.config) {
                                var n = b.config[e];
                                if (void 0 !== n && n.length > 0) for (var a = 0; n[a] && a < n.length; a++) n[a](b.selectedDates, b.input.value, b, t);
                                "onChange" === e && (b.input.dispatchEvent(Ce("change")), b.input.dispatchEvent(Ce("input")))
                            }
                        }
                        ...
                        function ke(e) {
                            void 0 === e && (e = !0), void 0 !== b.mobileInput && b.mobileFormatStr && (b.mobileInput.value = void 0 !== b.latestSelectedDateObj ? b.formatDate(b.latestSelectedDateObj, b.mobileFormatStr) : ""), b.input.value = Ee(b.config.dateFormat), void 0 !== b.altInput && (b.altInput.value = Ee(b.config.altFormat)), !1 !== e && ye("onValueUpdate")
                        }

                        function Te(e) {
                            var t = g(e), n = b.prevMonthNav.contains(t), a = b.nextMonthNav.contains(t);
                            n || a ? ee(n ? -1 : 1) : b.yearElements.indexOf(t) >= 0 ? t.select() : t.classList.contains("arrowUp") ? b.changeYear(b.currentYear + 1) : t.classList.contains("arrowDown") && b.changeYear(b.currentYear - 1)
                        }

                        return function () {
                            b.element = b.input = p, b.isOpen = !1, function () {
                                ...
                                for (var u = 0; u < t.length; u++) b.config[t[u]] = !0 === b.config[t[u]] || "true" === b.config[t[u]];
                                for (n.filter((function (e) {
                                    return void 0 !== b.config[e]
                                })).forEach((function (e) {
                                    b.config[e] = c(b.config[e] || []).map(_)
                                    ...
                                    for (var m in f) n.indexOf(m) > -1 ? b.config[m] = c(f[m]).map(_).concat(b.config[m]) : void 0 === i[m] && (b.config[m] = f[m])
                                }
                                i.altInputClass || (b.config.altInputClass = ue().className + " " + b.config.altInputClass), ye("onParseConfig")
                            }(), fe(), b.input = ue(), b.input ? (b.input._type = b.input.type, b.input.type = "text", b.input.classList.add("flatpickr-input"), b._input = b.input, b.config.altInput && (b.altInput = d(b.input.nodeName, b.config.altInputClass), b._input = b.altInput, b.altInput.placeholder = b.input.placeholder, b.altInput.disabled = b.input.disabled, b.altInput.required = b.input.required, b.altInput.tabIndex = b.input.tabIndex, b.altInput.type = "text", b.input.setAttribute("type", "hidden"), !b.config.static && b.input.parentNode && b.input.parentNode.insertBefore(b.altInput, b.input.nextSibling)), b.config.allowInput || b._input.setAttribute("readonly", "readonly"), we()) : b.config.errorHandler(new Error("Invalid input element specified")), function () {
                                ...
                                if (b.calendarContainer = d("div", "flatpickr-calendar"), b.calendarContainer.tabIndex = -1, !b.config.noCalendar) {
                                    if (e.appendChild((b.monthNav = d("div", "flatpickr-months"), b.yearElements = [], b.monthElements = [], b.prevMonthNav = d("span", "flatpickr-prev-month"), b.prevMonthNav.innerHTML = b.config.prevArrow, b.nextMonthNav = d("span", "flatpickr-next-month"), b.nextMonthNav.innerHTML = b.config.nextArrow, Z(), Object.defineProperty(b, "_hidePrevMonthArrow", {
                                        get: function () {
                                    ...
                                    }), b.currentYearElement = b.yearElements[0], xe(), b.monthNav)), b.innerContainer = d("div", "flatpickr-innerContainer"), b.config.weekNumbers) {
                                        var t = function () {
                                        ...
                                        b.innerContainer.appendChild(n), b.weekNumbers = a, b.weekWrapper = n
                                    }
                                    b.rContainer = d("div", "flatpickr-rContainer"), b.rContainer.appendChild(Q()), b.daysContainer || (b.daysContainer = d("div", "flatpickr-days"), b.daysContainer.tabIndex = -1), V(), b.rContainer.appendChild(b.daysContainer), b.innerContainer.appendChild(b.rContainer), e.appendChild(b.innerContainer)
                                }
                                b.config.enableTime && e.appendChild(function () {
                                    ...
                                    if (b.minuteElement = a.getElementsByTagName("input")[0], b.hourElement.tabIndex = b.minuteElement.tabIndex = -1, b.hourElement.value = o(b.latestSelectedDateObj ? b.latestSelectedDateObj.getHours() : b.config.time_24hr ? e.hours : function (e) {
                                        switch (e % 24) {
                                            case 0:
                                            case 12:
                                                return 12;
                                    ...
                                    }(e.hours)), b.minuteElement.value = o(b.latestSelectedDateObj ? b.latestSelectedDateObj.getMinutes() : e.minutes), b.hourElement.setAttribute("step", b.config.hourIncrement.toString()), b.minuteElement.setAttribute("step", b.config.minuteIncrement.toString()), b.hourElement.setAttribute("min", b.config.time_24hr ? "0" : "1"), b.hourElement.setAttribute("max", b.config.time_24hr ? "23" : "12"), b.hourElement.setAttribute("maxlength", "2"), b.minuteElement.setAttribute("min", "0"), b.minuteElement.setAttribute("max", "59"), b.minuteElement.setAttribute("maxlength", "2"), b.timeContainer.appendChild(n), b.timeContainer.appendChild(t), b.timeContainer.appendChild(a), b.config.time_24hr && b.timeContainer.classList.add("time24hr"), b.config.enableSeconds) {
                                        b.timeContainer.classList.add("hasSeconds");
                                        var i = m("flatpickr-second");
                                        b.secondElement = i.getElementsByTagName("input")[0], b.secondElement.value = o(b.latestSelectedDateObj ? b.latestSelectedDateObj.getSeconds() : e.seconds), b.secondElement.setAttribute("step", b.minuteElement.getAttribute("step")), b.secondElement.setAttribute("min", "0"), b.secondElement.setAttribute("max", "59"), b.secondElement.setAttribute("maxlength", "2"), b.timeContainer.appendChild(d("span", "flatpickr-time-separator", ":")), b.timeContainer.appendChild(i)
                                    }
                                    return b.config.time_24hr || (b.amPM = d("span", "flatpickr-am-pm", b.l10n.amPM[r((b.latestSelectedDateObj ? b.hourElement.value : b.config.defaultHour) > 11)]), b.amPM.title = b.l10n.toggleTitle, b.amPM.tabIndex = -1, b.timeContainer.appendChild(b.amPM)), b.timeContainer
                                }()), s(b.calendarContainer, "rangeMode", "range" === b.config.mode), s(b.calendarContainer, "animate", !0 === b.config.animate), s(b.calendarContainer, "multiMonth", b.config.showMonths > 1), b.calendarContainer.appendChild(e);
                                ...
                                if (b.config.wrap && ["open", "close", "toggle", "clear"].forEach((function (e) {
                                    Array.prototype.forEach.call(b.element.querySelectorAll("[data-" + e + "]"), (function (t) {
                                        return H(t, "click", b[e])
                                    }))
                                })), b.isMobile) !function () {
                                    var e = b.config.enableTime ? b.config.noCalendar ? "time" : "datetime-local" : "date";
                                    b.mobileInput = d("input", b.input.className + " flatpickr-mobile"), b.mobileInput.tabIndex = 1, b.mobileInput.type = e, b.mobileInput.disabled = b.input.disabled, b.mobileInput.required = b.input.required, b.mobileInput.placeholder = b.input.placeholder, b.mobileFormatStr = "datetime-local" === e ? "Y-m-d\\TH:i:S" : "date" === e ? "Y-m-d" : "H:i:S", b.selectedDates.length > 0 && (b.mobileInput.defaultValue = b.mobileInput.value = b.formatDate(b.selectedDates[0], b.mobileFormatStr)), b.config.minDate && (b.mobileInput.min = b.formatDate(b.config.minDate, "Y-m-d")), b.config.maxDate && (b.mobileInput.max = b.formatDate(b.config.maxDate, "Y-m-d")), b.input.getAttribute("step") && (b.mobileInput.step = String(b.input.getAttribute("step"))), b.input.type = "hidden", void 0 !== b.altInput && (b.altInput.type = "hidden");
                                    try {
                                        b.input.parentNode && b.input.parentNode.insertBefore(b.mobileInput, b.input.nextSibling)
                                    } catch (e) {
                                    }
                                    H(b.mobileInput, "change", (function (e) {
                                        b.setDate(g(e).value, !1, b.mobileFormatStr), ye("onChange"), ye("onClose")
                                    }))
                                }(); else {
                                    var e = l(se, 50);
                                    if (b._debouncedChange = l(L, S), b.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && H(b.daysContainer, "mouseover", (function (e) {
                                        "range" === b.config.mode && ce(g(e))
                                    })), H(b._input, "keydown", le), void 0 !== b.calendarContainer && H(b.calendarContainer, "keydown", le), b.config.inline || b.config.static || H(window, "resize", e), void 0 !== window.ontouchstart ? H(window.document, "touchstart", ne) : H(window.document, "mousedown", ne), H(window.document, "focus", ne, {capture: !0}), !0 === b.config.clickOpens && (H(b._input, "focus", b.open), H(b._input, "click", b.open)), void 0 !== b.daysContainer && (H(b.monthNav, "click", Te), H(b.monthNav, ["keyup", "increment"], j), H(b.daysContainer, "click", he)), void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement) {
                                        var t = function (e) {
                                            return g(e).select()
                                        };
                                        H(b.timeContainer, ["increment"], A), H(b.timeContainer, "blur", A, {capture: !0}), H(b.timeContainer, "click", W), H([b.hourElement, b.minuteElement], ["focus", "click"], t), void 0 !== b.secondElement && H(b.secondElement, "focus", (function () {
                                            return b.secondElement && b.secondElement.select()
                                        })), void 0 !== b.amPM && H(b.amPM, "click", (function (e) {
                                            A(e)
                                        }))
                                    }
                                    b.config.allowInput && H(b._input, "blur", re)
                                }
                            }(), (b.selectedDates.length || b.config.noCalendar) && (b.config.enableTime && P(b.config.noCalendar ? b.latestSelectedDateObj : void 0), ke(!1)), F();
                            var t = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
                            !b.isMobile && t && me(), ye("onReady")
                        }(), b
                    }
                    ...
                    function _(e, t) {
                        for (var n = Array.prototype.slice.call(e).filter((function (e) {
                            ...
                            try {
                                ...
                                void 0 !== o._flatpickr && (o._flatpickr.destroy(), o._flatpickr = void 0), o._flatpickr = I(o, t || {}), a.push(o._flatpickr)
                            } catch (e) {
                                console.error(e)
                            }
                        }
                    ...
                    }, O.parseDate = y({}), O.formatDate = w({}), O.compareDates = C, "undefined" != typeof jQuery && void 0 !== jQuery.fn && (jQuery.fn.flatpickr = function (e) {
                        return _(this, e)
